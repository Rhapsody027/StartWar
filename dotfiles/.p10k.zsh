# Generated by Powerlevel10k configuration wizard on 2025-04-12 at 10:56 CST.
...
# angled separators, sharp heads, blurred tails, 1 line, sparse, few icons, concise,
...
() {
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local   modified='%160F'  # yellow foreground
      local  untracked='%135'   # blue foreground
